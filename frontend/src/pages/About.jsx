    ...
    <div className="about-container">
      ...
      <nav className="about-nav">
        <div className="about-nav-container">
          <Link to="/" className="about-logo">
            ...
            <h1 className="about-logo-text">Collaboration Tool</h1>
          </Link>
      ...
      <div className="about-content">
        <div className="about-card">
          <h1 className="about-title">About Collaboration Tool</h1>

          <div className="about-content-sections">
            <div id="what-is" className="about-section">
              <h2 className="about-section-title">What is Collaboration Tool?</h2>
              <p className="about-section-content">
                Collabration Tool is a modern, collaborative workspace inspired by collaboration tools. Built with cutting-edge 
              ...
              <div className="about-tech-grid">
                <div className="about-tech-section">
                  ...
                  <ul className="about-tech-list">
                    ...
                    <li className="about-tech-item">  CSS for styling</li>
