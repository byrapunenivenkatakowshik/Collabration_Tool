      ...
      <nav className="landing-nav">
        <div className="landing-nav-container">
          <div className="landing-logo">
            ...
            <h1 className="landing-logo-text">Collaboration Tool</h1>
          </div>
      ...
      <div className="landing-hero" id="hero">
        <div className={`text-center transition-all duration-1000 ${isVisible.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="landing-hero-subtitle">
            ...
            Experience the future of collaborative writing with our collaboration platform.
          </p>
        ...
        <div className="landing-footer-content">
          <div className="landing-footer-top">
            <div className="landing-footer-logo">
              ...
              <span className="landing-footer-logo-text">Collaboration Tool</span>
            </div>
          ...
          <div className="landing-footer-bottom">
            <p>&copy; 2024 Collaboration Tool. Built with React, Node.js, and Firebase.</p>
          </div>
        </div>
      </footer>
    </div>
