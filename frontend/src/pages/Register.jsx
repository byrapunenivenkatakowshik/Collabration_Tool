...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Client-side validation for length limits
    if (email.length > 20) {
      setError('Email must be no more than 20 characters');
      return;
    }
    ...
    if (password.length > 10) {
      setError('Password must be no more than 10 characters');
      return;
    }
          ...
          <div className="register-form-fields">
            <div className="register-form-group">
              ...
              <input
                ...
                placeholder="Enter your username (max 15 chars)"
              />
            </div>
            ...
            <div className="register-form-group">
              ...
              <input
                ...
                className="register-form-input"
                placeholder="Enter your email (max 20 chars)"
              />
            </div>
